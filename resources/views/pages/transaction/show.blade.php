    ...
    <tr>
        ...
        <td>
            <table class="table table-bordered">
                ...
                @foreach ($item->transactionDetails as $transactionDetails)
                    <tr>
                        <td>{{ $transactionDetails->product->name }}</td>
                        <td>{{ $transactionDetails->product->type }}</td>
                        <td>$ {{ $transactionDetails->product->price }}</td>
                    </tr>
                @endforeach
            </table>
        </td>
